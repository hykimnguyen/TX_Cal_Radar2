// CVI wrapper header file for .NET assembly: NbTest, Version=2.9.0.34, Culture=neutral, PublicKeyToken=null
//
...
// CVI name: Alv_NarrowBand_UNT_DAT, .NET name: Alv.NarrowBand.UNT_DAT, Assembly: NbLib, Module: c:\nbdll\NbLib.dll
// CVI name: System_Numerics_Complex, .NET name: System.Numerics.Complex, Assembly: MathNet.Numerics, Module: c:\nbdll\MathNet.Numerics.dll
// CVI name: Alv_NarrowBand_NBProtocol_Processor, .NET name: Alv.NarrowBand.NBProtocol+Processor, Assembly: NbLib, Module: c:\nbdll\NbLib.dll
// CVI name: Alv_NarrowBand_NBProtocol_Antenna, .NET name: Alv.NarrowBand.NBProtocol+Antenna, Assembly: NbLib, Module: c:\nbdll\NbLib.dll
// CVI name: Alv_NarrowBand_NBProtocol_Status, .NET name: Alv.NarrowBand.NBProtocol+Status, Assembly: NbLib, Module: c:\nbdll\NbLib.dll
...
// CVI name: Alv_NarrowBand_NBProtocol_TestLED, .NET name: Alv.NarrowBand.NBProtocol+TestLED, Assembly: NbLib, Module: c:\nbdll\NbLib.dll
...
// CVI name: Alv_NarrowBand_NBProtocol_ConfigurationBlock, .NET name: Alv.NarrowBand.NBProtocol+ConfigurationBlock, Assembly: NbLib, Module: c:\nbdll\NbLib.dll
// CVI name: Alv_NarrowBand_HP_DIAG, .NET name: Alv.NarrowBand.HP_DIAG, Assembly: NbLib, Module: c:\nbdll\NbLib.dll
// CVI name: Alv_NarrowBand_NBProtocol_GearPosition, .NET name: Alv.NarrowBand.NBProtocol+GearPosition, Assembly: NbLib, Module: c:\nbdll\NbLib.dll
// CVI name: Alv_NarrowBand_NBProtocol_StaticTestMode, .NET name: Alv.NarrowBand.NBProtocol+StaticTestMode, Assembly: NbLib, Module: c:\nbdll\NbLib.dll
// CVI name: Alv_NarrowBand_NBProtocol_ControlRadarMode, .NET name: Alv.NarrowBand.NBProtocol+ControlRadarMode, Assembly: NbLib, Module: c:\nbdll\NbLib.dll
// CVI name: Alv_NarrowBand_Sensor, .NET name: Alv.NarrowBand.Sensor, Assembly: NbLib, Module: c:\nbdll\NbLib.dll
// CVI name: Alv_NarrowBand_DSP_DIAG, .NET name: Alv.NarrowBand.DSP_DIAG, Assembly: NbLib, Module: c:\nbdll\NbLib.dll
// CVI name: Alv_NarrowBand_NBProtocol_DCOffset, .NET name: Alv.NarrowBand.NBProtocol+DCOffset, Assembly: NbLib, Module: c:\nbdll\NbLib.dll

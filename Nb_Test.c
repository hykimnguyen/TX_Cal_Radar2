// CVI wrapper source file for .NET assembly: NbTest, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null
...
// Constants
static const char * __assemblyName = "NbTest, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
...
static int CVIFUNC Alv_Test_Sweep_AntennaPairs__Create(
	Alv_Test_Sweep_AntennaPairs * value,
	CDotNetHandle * handle,
	CDotNetHandle * __exception);
...
static int CVIFUNC Alv_NarrowBand_NBProtocol_TestLED__Create(
	...
	CDotNetHandle * handle,
	CDotNetHandle * __exception);
static int CVIFUNC Alv_GPIB_RS_FSV_TriggerSource__Create(
	Alv_GPIB_RS_FSV_TriggerSource * value,
	CDotNetHandle * handle,
	CDotNetHandle * __exception);
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: pair
	__errChk(Alv_Test_Sweep_AntennaPairs__Create(
		&pair, 
		&pair__, 
		__exception));
	__parameterTypeNames[0] = "Alv.Test.Sweep+AntennaPairs";
	__parameterTypes[0] = (CDOTNET_ENUM);
	__parameters[0] = &pair__;
	...
	CDotNetHandle * __exception)
{
	...
	unsigned int __parameterTypes[2];
	void * __parameters[2];
	CDotNetHandle right__ = 0;
	CDotNetAssemblyHandle __rightAssembly = 0;
	unsigned int __returnValueTypeId;
	...
	__parameterTypeNames[0] = "Alv.Test.Sweep";
	__parameterTypes[0] = (CDOTNET_OBJECT);
	__parameters[0] = &left;
	...
	__parameterTypeNames[1] = "System.Numerics.Complex[],System.Numerics, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089";
	__parameterTypes[1] = (CDOTNET_STRUCT | CDOTNET_ARRAY);
	__parameters[1] = &right__;
...
__Error:
	if (right__)
		CDotNetDiscardHandle(right__);
	if (__rightAssembly)
		CDotNetDiscardAssemblyHandle(__rightAssembly);
	if (__error < 0) {
		_CDotNetGenDisposeScalar(
			__returnValue, 
			CDOTNET_OBJECT);
	...
	CDotNetHandle * __exception)
{
	...
	unsigned int __parameterTypes[2];
	void * __parameters[2];
	CDotNetHandle left__ = 0;
	CDotNetAssemblyHandle __leftAssembly = 0;
	unsigned int __returnValueTypeId;
	...
	__parameterTypeNames[0] = "System.Numerics.Complex[],System.Numerics, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089";
	__parameterTypes[0] = (CDOTNET_STRUCT | CDOTNET_ARRAY);
	__parameters[0] = &left__;

	// Pre-process parameter: right
	__parameterTypeNames[1] = "Alv.Test.Sweep";
...
__Error:
	if (left__)
		CDotNetDiscardHandle(left__);
	if (__leftAssembly)
		CDotNetDiscardAssemblyHandle(__leftAssembly);
	if (__error < 0) {
		_CDotNetGenDisposeScalar(
			__returnValue, 
			CDOTNET_OBJECT);
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: order
	__parameterTypeNames[1] = "System.Int32";
	__parameterTypes[1] = (CDOTNET_INT32);
	__parameters[1] = &order;
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: AntParams
	__parameterTypeNames[1] = "System.Double[][]";
	__parameterTypes[1] = (CDOTNET_OBJECT);
	__parameters[1] = &AntParams;
	...
	CDotNetHandle * __exception)
{
	...
	void * __parameters[1];
	CDotNetHandle value__ = 0;
	CDotNetAssemblyHandle __valueAssembly = 0;
	CDotNetHandle __returnValue__ = 0;
	unsigned int __returnValueTypeId;
...
__Error:
	if (value__)
		CDotNetDiscardHandle(value__);
	if (__valueAssembly)
		CDotNetDiscardAssemblyHandle(__valueAssembly);
	if (__returnValue__)
		CDotNetDiscardHandle(__returnValue__);
	if (__error < 0) {
		_CDotNetGenDisposeArray(
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: Tx1
	__parameterTypeNames[0] = "System.Int32";
	__parameterTypes[0] = (CDOTNET_INT32);
	__parameters[0] = &Tx1;

	// Pre-process parameter: Tx2
	__parameterTypeNames[1] = "System.Int32";
	__parameterTypes[1] = (CDOTNET_INT32);
	__parameters[1] = &Tx2;
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: major
	__parameterTypeNames[0] = "System.Int32&";
	__parameterTypes[0] = (CDOTNET_INT32 | CDOTNET_OUT);
	__parameters[0] = major;

	// Pre-process parameter: minor
	__parameterTypeNames[1] = "System.Int32&";
	__parameterTypes[1] = (CDOTNET_INT32 | CDOTNET_OUT);
	__parameters[1] = minor;
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: rf_length
	__parameterTypeNames[0] = "System.Double";
	__parameterTypes[0] = (CDOTNET_DOUBLE);
	__parameters[0] = &rf_length;
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: ctl_sel
	__parameterTypeNames[0] = "System.UInt16";
	__parameterTypes[0] = (CDOTNET_UINT16);
	__parameters[0] = &ctl_sel;
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: application
	__parameterTypeNames[0] = "System.UInt16";
	__parameterTypes[0] = (CDOTNET_UINT16);
	__parameters[0] = &application;
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: persistence
	__parameterTypeNames[1] = "System.UInt16";
	__parameterTypes[1] = (CDOTNET_UINT16);
	__parameters[1] = &persistence;

	// Pre-process parameter: std_speed
	__parameterTypeNames[2] = "System.UInt16";
	__parameterTypes[2] = (CDOTNET_UINT16);
	__parameters[2] = &std_speed;

	// Pre-process parameter: cst_speed
	__parameterTypeNames[3] = "System.UInt32";
	__parameterTypes[3] = (CDOTNET_UINT32);
	__parameters[3] = &cst_speed;
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: module_id
	__parameterTypeNames[0] = "System.UInt16";
	__parameterTypes[0] = (CDOTNET_UINT16);
	__parameters[0] = &module_id;
	...
	CDotNetHandle * __exception)
{
	...
	__errChk(Alv_GPIB_RS_FSV_TriggerSource__Create(
		&trigger, 
		&trigger__, 
		__exception));
	__parameterTypeNames[0] = "Alv.GPIB.RS_FSV+TriggerSource";
	__parameterTypes[0] = (CDOTNET_ENUM);
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: swppts
	__parameterTypeNames[0] = "System.Double";
	__parameterTypes[0] = (CDOTNET_DOUBLE);
	__parameters[0] = &swppts;
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: acceleration
	__parameterTypeNames[1] = "System.Int32";
	__parameterTypes[1] = (CDOTNET_INT32);
	__parameters[1] = &acceleration;
	...
	CDotNetHandle * __exception)
{
	...
	*__instance = 0;
	...
	__parameterTypeNames[0] = "System.Collections.Generic.IEnumerable`1[[System.Numerics.Complex, System.Numerics, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]]";
	__parameterTypes[0] = (CDOTNET_OBJECT);
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: NewSize
	__parameterTypeNames[1] = "System.Int32";
	__parameterTypes[1] = (CDOTNET_INT32);
	__parameters[1] = &NewSize;
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: FFT_size
	__parameterTypeNames[2] = "System.Int32";
	__parameterTypes[2] = (CDOTNET_INT32);
	__parameters[2] = &FFT_size;
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: select
	__parameterTypeNames[0] = "System.Boolean";
	__parameterTypes[0] = (CDOTNET_BOOLEAN);
	__parameters[0] = &select;
	...
	CDotNetHandle * __exception)
{
	...
	void * __parameters[3];
	CDotNetHandle points__ = 0;
	CDotNetHandle signal__ = 0;
	CDotNetHandle noise__ = 0;
	unsigned int __returnValueTypeId;
	...
	*__noiseLength = 0;
	...
	// Pre-process parameter: signal
	__parameterTypeNames[1] = "System.Double[]&";
	__parameterTypes[1] = (CDOTNET_DOUBLE | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[1] = &signal__;

	// Pre-process parameter: noise
	__parameterTypeNames[2] = "System.Double[]&";
	__parameterTypes[2] = (CDOTNET_DOUBLE | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[2] = &noise__;
...
__Error:
	if (points__)
		CDotNetDiscardHandle(points__);
	if (signal__)
		CDotNetDiscardHandle(signal__);
	if (noise__)
		CDotNetDiscardHandle(noise__);
	if (__error < 0) {
		_CDotNetGenDisposeArray(
			points, 
			CDOTNET_DOUBLE, 
	...
	CDotNetHandle * __exception)
{
	...
	__parameterTypeNames[5] = "System.Double&";
	__parameterTypes[5] = (CDOTNET_DOUBLE | CDOTNET_OUT);
	__parameters[5] = azimuth;

	// Pre-process parameter: distance
	__parameterTypeNames[6] = "System.Double&";
	__parameterTypes[6] = (CDOTNET_DOUBLE | CDOTNET_OUT);
	__parameters[6] = distance;

	// Pre-process parameter: speed
	__parameterTypeNames[7] = "System.Double&";
	__parameterTypes[7] = (CDOTNET_DOUBLE | CDOTNET_OUT);
	__parameters[7] = speed;

	// Pre-process parameter: SNR
	__parameterTypeNames[8] = "System.Double&";
	__parameterTypes[8] = (CDOTNET_DOUBLE | CDOTNET_OUT);
	__parameters[8] = SNR;
	...
	CDotNetHandle * __exception)
{
	...
	*__pointsLength2 = 0;
	...
	// Pre-process parameter: squint
	__parameterTypeNames[1] = "System.Boolean";
	__parameterTypes[1] = (CDOTNET_BOOLEAN);
	__parameters[1] = &squint;

	// Pre-process parameter: points
	__parameterTypeNames[2] = "System.Double[,]&";
	__parameterTypes[2] = (CDOTNET_DOUBLE | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[2] = &points__;
	...
	CDotNetHandle * __exception)
{
	...
	*__pointsLength2 = 0;
	...
	// Pre-process parameter: peak_target
	__parameterTypeNames[0] = "System.Int32";
	__parameterTypes[0] = (CDOTNET_INT32);
	__parameters[0] = &peak_target;

	// Pre-process parameter: peak
	__parameterTypeNames[1] = "System.Double[]&";
	__parameterTypes[1] = (CDOTNET_DOUBLE | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[1] = &peak__;
	...
	CDotNetHandle * __exception)
{
	...
	*TableTrueValues = 0;
	...
	// Pre-process parameter: wait_time
	__parameterTypeNames[4] = "System.Int32";
	__parameterTypes[4] = (CDOTNET_INT32);
	__parameters[4] = &wait_time;

	// Pre-process parameter: set_time
	__parameterTypeNames[5] = "System.Int32";
	__parameterTypes[5] = (CDOTNET_INT32);
	__parameters[5] = &set_time;

	// Pre-process parameter: measured_theta
	__parameterTypeNames[6] = "System.Double[,]&";
	__parameterTypes[6] = (CDOTNET_DOUBLE | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[6] = &measured_theta__;

	// Pre-process parameter: beam_formed_theta
	__parameterTypeNames[7] = "System.Double[][]&";
	__parameterTypes[7] = (CDOTNET_OBJECT | CDOTNET_OUT);
	__parameters[7] = beam_formed_theta;

	// Pre-process parameter: TableCalcPoints
	__parameterTypeNames[8] = "System.UInt16[][]&";
	__parameterTypes[8] = (CDOTNET_OBJECT | CDOTNET_OUT);
	__parameters[8] = TableCalcPoints;

	// Pre-process parameter: TableCalcValues
	__parameterTypeNames[9] = "System.Double[][]&";
	__parameterTypes[9] = (CDOTNET_OBJECT | CDOTNET_OUT);
	__parameters[9] = TableCalcValues;

	// Pre-process parameter: TableTruePoints
	__parameterTypeNames[10] = "System.UInt16[][]&";
	__parameterTypes[10] = (CDOTNET_OBJECT | CDOTNET_OUT);
	__parameters[10] = TableTruePoints;

	// Pre-process parameter: TableTrueValues
	__parameterTypeNames[11] = "System.Double[][]&";
	__parameterTypes[11] = (CDOTNET_OBJECT | CDOTNET_OUT);
	__parameters[11] = TableTrueValues;
	...
	CDotNetHandle * __exception)
{
	...
	*__pointsLength2 = 0;
	...
	// Pre-process parameter: initDAC_AMP
	__parameterTypeNames[1] = "System.Int32";
	__parameterTypes[1] = (CDOTNET_INT32);
	__parameters[1] = &initDAC_AMP;

	// Pre-process parameter: initDAC_SW
	__parameterTypeNames[2] = "System.Int32";
	__parameterTypes[2] = (CDOTNET_INT32);
	__parameters[2] = &initDAC_SW;

	// Pre-process parameter: pow_min
	__parameterTypeNames[3] = "System.Double";
	__parameterTypes[3] = (CDOTNET_DOUBLE);
	__parameters[3] = &pow_min;

	// Pre-process parameter: pow_max
	__parameterTypeNames[4] = "System.Double";
	__parameterTypes[4] = (CDOTNET_DOUBLE);
	__parameters[4] = &pow_max;

	// Pre-process parameter: power
	__parameterTypeNames[5] = "System.Double&";
	__parameterTypes[5] = (CDOTNET_DOUBLE | CDOTNET_OUT);
	__parameters[5] = power;

	// Pre-process parameter: points
	__parameterTypeNames[6] = "System.Double[,]&";
	__parameterTypes[6] = (CDOTNET_DOUBLE | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[6] = &points__;
	...
	CDotNetHandle * __exception)
{
	...
	*__pdetLength = 0;
	...
	__parameterTypeNames[4] = "System.Int32";
	__parameterTypes[4] = (CDOTNET_INT32);
	__parameters[4] = &initDAC_AMP;

	// Pre-process parameter: initDAC_SW
	__parameterTypeNames[5] = "System.Int32";
	__parameterTypes[5] = (CDOTNET_INT32);
	__parameters[5] = &initDAC_SW;

	// Pre-process parameter: power
	__parameterTypeNames[6] = "System.Double[]&";
	__parameterTypes[6] = (CDOTNET_DOUBLE | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[6] = &power__;

	// Pre-process parameter: amp
	__parameterTypeNames[7] = "System.UInt16[]&";
	__parameterTypes[7] = (CDOTNET_UINT16 | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[7] = &amp__;

	// Pre-process parameter: sw
	__parameterTypeNames[8] = "System.UInt16[]&";
	__parameterTypes[8] = (CDOTNET_UINT16 | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[8] = &sw__;

	// Pre-process parameter: pdet
	__parameterTypeNames[9] = "System.UInt16[]&";
	__parameterTypes[9] = (CDOTNET_UINT16 | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[9] = &pdet__;

	// Pre-process parameter: thermistor
	__parameterTypeNames[10] = "System.UInt16&";
	__parameterTypes[10] = (CDOTNET_UINT16 | CDOTNET_OUT);
	__parameters[10] = thermistor;
	...
	CDotNetHandle * __exception)
{
	...
	void * __parameters[6];
	CDotNetHandle offset__ = 0;
	CDotNetHandle Average__ = 0;
	CDotNetHandle NumbZeroCrossing__ = 0;
	unsigned int __returnValueTypeId;
	...
	*__AverageLength = 0;
	*NumbZeroCrossing = 0;
	*__NumbZeroCrossingLength = 0;
	*trace = 0;


	// Pre-process parameter: average_time
	__parameterTypeNames[0] = "System.Int32";
	__parameterTypes[0] = (CDOTNET_INT32);
	__parameters[0] = &average_time;

	// Pre-process parameter: temp
	__parameterTypeNames[1] = "System.Double&";
	__parameterTypes[1] = (CDOTNET_DOUBLE | CDOTNET_OUT);
	__parameters[1] = temp;
	...
	__parameterTypeNames[2] = "System.Double[]&";
	__parameterTypes[2] = (CDOTNET_DOUBLE | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[2] = &offset__;

	// Pre-process parameter: Average
	__parameterTypeNames[3] = "System.Double[]&";
	__parameterTypes[3] = (CDOTNET_DOUBLE | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[3] = &Average__;

	// Pre-process parameter: NumbZeroCrossing
	__parameterTypeNames[4] = "System.Int32[]&";
	__parameterTypes[4] = (CDOTNET_INT32 | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[4] = &NumbZeroCrossing__;

	// Pre-process parameter: trace
	__parameterTypeNames[5] = "System.Double[][]&";
	__parameterTypes[5] = (CDOTNET_OBJECT | CDOTNET_OUT);
	__parameters[5] = trace;
	...
	// Post-process parameter: Average
	if (Average__) {
		__errChk(CDotNetGetArrayElements(
			Average__, 
			CDOTNET_DOUBLE, 
	...
	// Post-process parameter: NumbZeroCrossing
	if (NumbZeroCrossing__) {
		__errChk(CDotNetGetArrayElements(
			NumbZeroCrossing__, 
			CDOTNET_INT32, 
			0, 
		...
		__errChk(CDotNetGetArrayLength(
			NumbZeroCrossing__, 
			0, 
			__NumbZeroCrossingLength));
	}


__Error:
	if (offset__)
		CDotNetDiscardHandle(offset__);
	if (Average__)
		CDotNetDiscardHandle(Average__);
	if (NumbZeroCrossing__)
		CDotNetDiscardHandle(NumbZeroCrossing__);
	if (__error < 0) {
		_CDotNetGenDisposeArray(
			offset, 
			CDOTNET_DOUBLE, 
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: velmex
	__parameterTypeNames[0] = "System.Boolean";
	__parameterTypes[0] = (CDOTNET_BOOLEAN);
	__parameters[0] = &velmex;
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: upperP
	__parameterTypeNames[2] = "System.Double&";
	__parameterTypes[2] = (CDOTNET_DOUBLE | CDOTNET_OUT);
	__parameters[2] = upperP;

	// Pre-process parameter: upperF
	__parameterTypeNames[3] = "System.Double&";
	__parameterTypes[3] = (CDOTNET_DOUBLE | CDOTNET_OUT);
	__parameters[3] = upperF;

	// Pre-process parameter: lowerP
	__parameterTypeNames[4] = "System.Double&";
	__parameterTypes[4] = (CDOTNET_DOUBLE | CDOTNET_OUT);
	__parameters[4] = lowerP;

	// Pre-process parameter: lowerF
	__parameterTypeNames[5] = "System.Double&";
	__parameterTypes[5] = (CDOTNET_DOUBLE | CDOTNET_OUT);
	__parameters[5] = lowerF;
	...
	CDotNetHandle * __exception)
{
	...
	unsigned int __parameterTypes[8];
	void * __parameters[8];
	CDotNetHandle returnPoints__ = 0;
	CDotNetHandle signal__ = 0;
	CDotNetHandle noise__ = 0;
	unsigned int __returnValueTypeId;
	...
	*SavedParams = 0;
	*returnPoints = 0;
	*__returnPointsLength1 = 0;
	*__returnPointsLength2 = 0;
	*signal = 0;
	*__signalLength = 0;
	*noise = 0;
	*__noiseLength = 0;
	...
	// Pre-process parameter: raw
	__parameterTypeNames[0] = "Alv.Test.Sweep&";
	__parameterTypes[0] = (CDOTNET_OBJECT | CDOTNET_OUT);
	__parameters[0] = raw;

	// Pre-process parameter: conditioned
	__parameterTypeNames[1] = "Alv.Test.Sweep&";
	__parameterTypes[1] = (CDOTNET_OBJECT | CDOTNET_OUT);
	__parameters[1] = conditioned;

	// Pre-process parameter: balanced
	__parameterTypeNames[2] = "Alv.Test.Sweep&";
	__parameterTypes[2] = (CDOTNET_OBJECT | CDOTNET_OUT);
	__parameters[2] = balanced;

	// Pre-process parameter: AntParams
	__parameterTypeNames[3] = "System.Double[][]&";
	__parameterTypes[3] = (CDOTNET_OBJECT | CDOTNET_OUT);
	__parameters[3] = AntParams;

	// Pre-process parameter: SavedParams
	__parameterTypeNames[4] = "System.Double[][]&";
	__parameterTypes[4] = (CDOTNET_OBJECT | CDOTNET_OUT);
	__parameters[4] = SavedParams;

	// Pre-process parameter: returnPoints
	__parameterTypeNames[5] = "System.Double[,]&";
	__parameterTypes[5] = (CDOTNET_DOUBLE | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[5] = &returnPoints__;

	// Pre-process parameter: signal
	__parameterTypeNames[6] = "System.Double[]&";
	__parameterTypes[6] = (CDOTNET_DOUBLE | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[6] = &signal__;

	// Pre-process parameter: noise
	__parameterTypeNames[7] = "System.Double[]&";
	__parameterTypes[7] = (CDOTNET_DOUBLE | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[7] = &noise__;
	...
	// Post-process parameter: returnPoints
	if (returnPoints__) {
		__errChk(CDotNetGetArrayElements(
			returnPoints__, 
			CDOTNET_DOUBLE, 
		...
		__errChk(CDotNetGetArrayLength(
			returnPoints__, 
			0, 
			__returnPointsLength1));
		__errChk(CDotNetGetArrayLength(
			returnPoints__, 
			1, 
			__returnPointsLength2));
	}
...
__Error:
	if (returnPoints__)
		CDotNetDiscardHandle(returnPoints__);
	if (signal__)
		CDotNetDiscardHandle(signal__);
	if (noise__)
		CDotNetDiscardHandle(noise__);
	...
	CDotNetHandle * __exception)
{
	...
	void * __parameters[5];
	CDotNetHandle peak__ = 0;
	CDotNetHandle bsd_vga_gain__ = 0;
	CDotNetHandle rcta_vga_gain__ = 0;
	unsigned int __returnValueTypeId;
	...
	*__peakLength = 0;
	*bsd_vga_gain = 0;
	*__bsd_vga_gainLength = 0;
	*rcta_vga_gain = 0;
	*__rcta_vga_gainLength = 0;
	...
	__parameterTypeNames[1] = "Alv.Test.Sweep&";
	__parameterTypes[1] = (CDOTNET_OBJECT | CDOTNET_OUT);
	__parameters[1] = waves;

	// Pre-process parameter: peak
	__parameterTypeNames[2] = "System.Double[]&";
	__parameterTypes[2] = (CDOTNET_DOUBLE | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[2] = &peak__;

	// Pre-process parameter: bsd_vga_gain
	__parameterTypeNames[3] = "System.UInt16[]&";
	__parameterTypes[3] = (CDOTNET_UINT16 | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[3] = &bsd_vga_gain__;

	// Pre-process parameter: rcta_vga_gain
	__parameterTypeNames[4] = "System.UInt16[]&";
	__parameterTypes[4] = (CDOTNET_UINT16 | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[4] = &rcta_vga_gain__;
	...
	// Post-process parameter: bsd_vga_gain
	if (bsd_vga_gain__) {
		__errChk(CDotNetGetArrayElements(
			bsd_vga_gain__, 
			CDOTNET_UINT16, 
		...
		__errChk(CDotNetGetArrayLength(
			bsd_vga_gain__, 
			0, 
			__bsd_vga_gainLength));
	}

	// Post-process parameter: rcta_vga_gain
	if (rcta_vga_gain__) {
		__errChk(CDotNetGetArrayElements(
			rcta_vga_gain__, 
			CDOTNET_UINT16, 
...
__Error:
	if (peak__)
		CDotNetDiscardHandle(peak__);
	if (bsd_vga_gain__)
		CDotNetDiscardHandle(bsd_vga_gain__);
	if (rcta_vga_gain__)
		CDotNetDiscardHandle(rcta_vga_gain__);
	if (__error < 0) {
		_CDotNetGenDisposeScalar(
			waves, 
			CDOTNET_OBJECT);
	...
	CDotNetHandle * __exception)
{
	...
	*__noiseLength = 0;
	...
	__parameterTypeNames[2] = "System.Double[]&";
	__parameterTypes[2] = (CDOTNET_DOUBLE | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[2] = &signal__;

	// Pre-process parameter: noise
	__parameterTypeNames[3] = "System.Double[]&";
	__parameterTypes[3] = (CDOTNET_DOUBLE | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[3] = &noise__;
	...
	CDotNetHandle * __exception)
{
	...
	*table = 0;
	...
	// Pre-process parameter: start_angle
	__parameterTypeNames[1] = "System.Double";
	__parameterTypes[1] = (CDOTNET_DOUBLE);
	__parameters[1] = &start_angle;

	// Pre-process parameter: stop_angle
	__parameterTypeNames[2] = "System.Double";
	__parameterTypes[2] = (CDOTNET_DOUBLE);
	__parameters[2] = &stop_angle;

	// Pre-process parameter: step_angle
	__parameterTypeNames[3] = "System.Double";
	__parameterTypes[3] = (CDOTNET_DOUBLE);
	__parameters[3] = &step_angle;

	// Pre-process parameter: Velmax_settle_time
	__parameterTypeNames[4] = "System.Int32";
	__parameterTypes[4] = (CDOTNET_INT32);
	__parameters[4] = &Velmax_settle_time;

	// Pre-process parameter: TrueAngles
	__parameterTypeNames[5] = "System.Double[]&";
	__parameterTypes[5] = (CDOTNET_DOUBLE | CDOTNET_ARRAY | CDOTNET_OUT);
	__parameters[5] = &TrueAngles__;

	// Pre-process parameter: raw_IQ
	__parameterTypeNames[6] = "System.Double[][][]&";
	__parameterTypes[6] = (CDOTNET_OBJECT | CDOTNET_OUT);
	__parameters[6] = raw_IQ;

	// Pre-process parameter: avg_IQ
	__parameterTypeNames[7] = "System.Double[][]&";
	__parameterTypes[7] = (CDOTNET_OBJECT | CDOTNET_OUT);
	__parameters[7] = avg_IQ;

	// Pre-process parameter: table
	__parameterTypeNames[8] = "System.Double[][]&";
	__parameterTypes[8] = (CDOTNET_OBJECT | CDOTNET_OUT);
	__parameters[8] = table;
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: Product
	__parameterTypeNames[0] = "System.String";
	__parameterTypes[0] = (CDOTNET_STRING);
	__parameters[0] = &Product;
	...
	CDotNetHandle * __exception)
{
	...
	__parameterTypeNames[3] = "System.Double&";
	__parameterTypes[3] = (CDOTNET_DOUBLE | CDOTNET_OUT);
	__parameters[3] = upper;

	// Pre-process parameter: lower
	__parameterTypeNames[4] = "System.Double&";
	__parameterTypes[4] = (CDOTNET_DOUBLE | CDOTNET_OUT);
	__parameters[4] = lower;
	...
	CDotNetHandle * __exception)
{
	...
	__parameterTypeNames[3] = "System.Double&";
	__parameterTypes[3] = (CDOTNET_DOUBLE | CDOTNET_OUT);
	__parameters[3] = upperP;

	// Pre-process parameter: upperF
	__parameterTypeNames[4] = "System.Double&";
	__parameterTypes[4] = (CDOTNET_DOUBLE | CDOTNET_OUT);
	__parameters[4] = upperF;

	// Pre-process parameter: lowerP
	__parameterTypeNames[5] = "System.Double&";
	__parameterTypes[5] = (CDOTNET_DOUBLE | CDOTNET_OUT);
	__parameters[5] = lowerP;

	// Pre-process parameter: lowerF
	__parameterTypeNames[6] = "System.Double&";
	__parameterTypes[6] = (CDOTNET_DOUBLE | CDOTNET_OUT);
	__parameters[6] = lowerF;
	...
	CDotNetHandle * __exception)
{
	...
	// Pre-process parameter: PolyOrder
	__parameterTypeNames[0] = "System.Int32";
	__parameterTypes[0] = (CDOTNET_INT32);
	__parameters[0] = &PolyOrder;

	...
	CDotNetHandle * __exception)
{
	...
	__parameterTypeNames[0] = "Alv.NarrowBand.Sensor,NbLib, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
	__parameterTypes[0] = (CDOTNET_OBJECT);
	__parameters[0] = &comm;
	...
	CDotNetHandle * __exception)
{
	...
	__errChk(Alv_NarrowBand_NBProtocol_Antenna__Create(
		...
		&antenna__, 
		__exception));
	__parameterTypeNames[0] = "Alv.NarrowBand.NBProtocol+Antenna,NbLib, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
	...
	CDotNetHandle * __exception)
{
	...
	__errChk(Alv_NarrowBand_NBProtocol_ControlRadarMode__Create(
		...
		&mode__, 
		__exception));
	__parameterTypeNames[0] = "Alv.NarrowBand.NBProtocol+ControlRadarMode,NbLib, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
	__parameterTypes[0] = (CDOTNET_ENUM);
	...
	CDotNetHandle * __exception)
{
	...
	__errChk(Alv_NarrowBand_NBProtocol_Antenna__Create(
		...
		&antenna__, 
		__exception));
	__parameterTypeNames[1] = "Alv.NarrowBand.NBProtocol+Antenna,NbLib, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
	...
	CDotNetHandle * __exception)
{
	...
	__errChk(Alv_NarrowBand_NBProtocol_DCOffset__Create(
		...
		&DCOffset__, 
		__exception));
	__parameterTypeNames[0] = "Alv.NarrowBand.NBProtocol+DCOffset,NbLib, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
	__parameterTypes[0] = (CDOTNET_ENUM);
	...
	CDotNetHandle * __exception)
{
	...
	__errChk(Alv_NarrowBand_NBProtocol_StaticTestMode__Create(
		...
		&StaticTestMode__, 
		__exception));
	__parameterTypeNames[0] = "Alv.NarrowBand.NBProtocol+StaticTestMode,NbLib, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
	__parameterTypes[0] = (CDOTNET_ENUM);
	...
	CDotNetHandle * __exception)
{
	...
	__errChk(Alv_NarrowBand_NBProtocol_ConfigurationBlock__Create(
		...
		&block__, 
		__exception));
	__parameterTypeNames[0] = "Alv.NarrowBand.NBProtocol+ConfigurationBlock,NbLib, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
	__parameterTypes[0] = (CDOTNET_ENUM);
	...
	CDotNetHandle * __exception)
{
	...
	__errChk(Alv_NarrowBand_NBProtocol_Processor__Create(
		...
		&processor__, 
		__exception));
	__parameterTypeNames[0] = "Alv.NarrowBand.NBProtocol+Processor,NbLib, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
	__parameterTypes[0] = (CDOTNET_ENUM);
	...
	CDotNetHandle * __exception)
{
	...
	__errChk(Alv_NarrowBand_NBProtocol_TestLED__Create(
		...
		&control__, 
		__exception));
	__parameterTypeNames[1] = "Alv.NarrowBand.NBProtocol+TestLED,NbLib, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
	__parameterTypes[1] = (CDOTNET_ENUM);
	...
	CDotNetHandle * __exception)
{
	...
	*sweep_data = 0;
	...
	__errChk(Alv_NarrowBand_NBProtocol_ControlRadarMode__Create(
		...
		&mode__, 
		__exception));
	__parameterTypeNames[2] = "Alv.NarrowBand.NBProtocol+ControlRadarMode,NbLib, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
	...
	CDotNetHandle * __exception)
{
	...
	__errChk(Alv_NarrowBand_NBProtocol_ControlRadarMode__Create(
		...
		&mode__, 
		__exception));
	__parameterTypeNames[1] = "Alv.NarrowBand.NBProtocol+ControlRadarMode,NbLib, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
	__parameterTypes[1] = (CDOTNET_ENUM);
	...
	CDotNetHandle * __exception)
{
	...
	*msg = 0;
	...
	__parameterTypeNames[0] = "Alv.NarrowBand.DSP_DIAG&,NbLib, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
	__parameterTypes[0] = (CDOTNET_OBJECT | CDOTNET_OUT);
	__parameters[0] = msg;
	...
	CDotNetHandle * __exception)
{
	...
	*msg = 0;
	...
	// Pre-process parameter: msg
	__parameterTypeNames[0] = "Alv.NarrowBand.HP_DIAG&,NbLib, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
	__parameterTypes[0] = (CDOTNET_OBJECT | CDOTNET_OUT);
	__parameters[0] = msg;
	...
	CDotNetHandle * __exception)
{
	...
	*msg = 0;
	...
	// Pre-process parameter: msg
	__parameterTypeNames[0] = "Alv.NarrowBand.UNT_DAT&,NbLib, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
	__parameterTypes[0] = (CDOTNET_OBJECT | CDOTNET_OUT);
	__parameters[0] = msg;
	...
	CDotNetHandle * __exception)
{
	...
	__errChk(Alv_NarrowBand_NBProtocol_GearPosition__Create(
		...
		&gear__, 
		__exception));
	__parameterTypeNames[0] = "Alv.NarrowBand.NBProtocol+GearPosition,NbLib, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
	__parameterTypes[0] = (CDOTNET_ENUM);
	...
	CDotNetHandle * __exception)
{
	...
	if (msgs) {
		__errChk(CDotNetLoadAssembly(
			"NbLib, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", 
			&__msgsAssembly));

...
//#define			DYN_RADIO_INT1_CONST				6
//#define			DYN_RADIO_INT2_CONST     			6
//#define			DYN_RADIO_INT3_CONST     		   	6
//#define			DYN_RADIO_INT4_CONST				6
...
//#define			UNITS_PER_BANK 						5
//#define			NUM_TESTS							3
//#define   		NUM_DUT_INPUTS						15
//#define			NUM_BANKS 							3
...
///#define			DYN_NUMERIC1_CONST   			   	40
///#define			DYN_NUMERIC2_CONST   				40
///#define			DYN_NUMERIC3_CONST   				10
...
//*******************************************************************************************************************
// APP_UTILITY Module Data
//*******************************************************************************************************************
///char			Util_ButtonTitle1[10][100];
///char			Util_ButtonTitle2[10][100];
///char			Util_LED1_LABEL_TITLE[10][100];
///char			UTIL_RADIO_LABEL_TITLE[10][100];
//*******************************************************************************************************************
...
///unsigned char 			SendBuffer[BUFF_SIZE], RecBuffer[BUFF_SIZE], RowRecMsg[BUFF_SIZE];
...
struct	TBP			PART_CONFIG_TableParameters, *Ptr_PART_CONFIG_TableParameters, AI_CONFIG_TableParameters, *Ptr_AI_CONFIG_TableParameters,
					...
					FRC_CONFIG_TableParameters, *Ptr_FRC_CONFIG_TableParameters, MSCI_CONFIG_TableParameters, *Ptr_MISC_CONFIG_TableParameters, 
					...
					*Ptr_DIO2_CONFIG_TableParameters,MSCI_CONFIG_TableParameters, *Ptr_MISC_CONFIG_TableParameter, 	PART_CONFIG_TableParameters, *Ptr_PART_CONFIG_TableParameters,
					FRC_CONFIG_TableParameters, *Ptr_FRC_CONFIG_TableParameter;
...
struct 	TCP 		PART_CONFIG_ColumnParameters[NUMBEROFTABLESCONST], *Ptr_PART_CONFIG_ColumnParameters,
					...
					*Ptr_FRC_CONFIG_ColumnParameters, FRC_CONFIG_ColumnParameters[NUMBEROFTABLESCONST],
...
///int 			NEST_1_ENABLED, NEST_2_ENABLED;
//*******************************************************************************************************************
...
//////////void  __stdcall   OpenFileNotePad(char ConfiurationPathName[]);
//*******************************************************************************************************************
int			NumberofTableRows;
